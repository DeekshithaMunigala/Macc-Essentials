...
import featureImage1 from "../assets/feature-img1.png";
import DiscountProductCards from "./DiscountProductCards";
import { IoIosArrowForward } from "react-icons/io";
import { useState, useRef } from "react";
import { Link } from "react-router-dom";

const MaccWeeklyDiscount = () => {
  ...
  return (
    <div className="w-[1321px] h-[673px] flex lg:flex-row sm:flex-col mb-24">
      <img
        src={featureImage1}
        alt="feature-img1"
        ...
        <div className="relative">
          ...
          >
            {products.map((product) => (
              ...
              >
                <DiscountProductCards data={product} key={product.asin} />
              </Link>
            ))}
          </div>
          ...
          <IoIosArrowForward
            onClick={handleNext}
            className={`absolute ml-8 right-0 top-[50%] h-9 w-9 text-gray bg-white rounded-full shadow-md cursor-pointer ${
...
export default MaccWeeklyDiscount;
